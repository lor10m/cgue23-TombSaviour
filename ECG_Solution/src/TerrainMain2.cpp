...
//
//    Camera camera(window, (60 * 3.14159265 / 180.0), (double)800 / (double)800, 0.1, 100);
//
...
//    unsigned char* data = stbi_load("assets/heightmaps/iceland_heightmap.png", &width, &height, &nrChannels, 0);
//    if (data)
//    {
